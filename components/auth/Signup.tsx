    ...
    <div className="min-h-screen flex">
      ...
      >
        ...
        <div className="w-full max-w-md bg-white rounded-lg shadow-xl p-8 relative z-10 my-8">
          ...
          {confirmationEmail ? (
            <div className="rounded-2xl border border-blue-100 bg-blue-50/60 px-6 py-8 text-center">
              <div className="mx-auto flex h-14 w-14 items-center justify-center rounded-full bg-white shadow-sm">
                <CircleCheckBig className="h-7 w-7 text-blue-600" />
              </div>
              ...
              <p className="mt-3 text-sm text-gray-500">
                Once confirmed, you can continue from the login page.
              </p>
