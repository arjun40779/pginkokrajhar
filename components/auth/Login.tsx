...
export default function Login() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    let destination = nextPath || '/resident';
        ...
        <div className="w-full max-w-md bg-white rounded-lg shadow-xl p-8 relative z-10">
          <div className="mb-8">
            <Link href="/" className="flex items-center mb-4">
              <div className="mb-4 inline-flex items-center rounded-full border border-blue-100 bg-blue-50 px-3 py-1 text-xs font-medium uppercase tracking-[0.18em] text-blue-700">
                PG Inkokrajhar
              </div>
            </Link>
